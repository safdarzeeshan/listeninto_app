...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'listeningto_playlist', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'listeningto', ['Playlist'])

        # Adding field 'Song.playlist'
        db.add_column(u'listeningto_song', 'playlist',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['listeningto.Playlist'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Playlist'
        db.delete_table(u'listeningto_playlist')

        # Deleting field 'Song.playlist'
        db.delete_column(u'listeningto_song', 'playlist_id')
    ...
    models = {
        ...
        u'listeningto.song': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'playlist': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['listeningto.Playlist']", 'null': 'True'}),
