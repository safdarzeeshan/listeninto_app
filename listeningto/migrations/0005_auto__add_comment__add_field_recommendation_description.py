...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'listeningto_comment', (
            ...
            ('recommendation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['listeningto.Recommendation'])),
        ))
        db.send_create_signal(u'listeningto', ['Comment'])

        # Adding field 'Recommendation.description'
        db.add_column(u'listeningto_recommendation', 'description',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'listeningto_comment')

        # Deleting field 'Recommendation.description'
        db.delete_column(u'listeningto_recommendation', 'description')
