...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'listeningto_recommendation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('receipient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sent_recommendation', to=orm['auth.User'])),
            ('song', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['listeningto.Song'])),
        ))
        db.send_create_signal(u'listeningto', ['Recommendation'])


    def backwards(self, orm):
        # Deleting model 'Recommendation'
        db.delete_table(u'listeningto_recommendation')
