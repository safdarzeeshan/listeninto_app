...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recommendation.played'
        db.add_column(u'listeningto_recommendation', 'played',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recommendation.played'
        db.delete_column(u'listeningto_recommendation', 'played')
